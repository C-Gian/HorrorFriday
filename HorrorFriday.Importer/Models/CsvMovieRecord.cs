...
/// <summary>
/// Rappresenta una riga del CSV Kaggle.
/// Ogni proprietà corrisponde a una colonna del file.
/// L'attributo [Name("...")] dice a CsvHelper quale colonna del CSV mappare.
/// </summary>
public class CsvMovieRecord
{
    ...
    [Name("vote_average")]
    public string VoteAverage { get; set; } = string.Empty;

    [Name("vote_count")]
    public string VoteCount { get; set; } = string.Empty;
